...
boolean bIncludeCoding = request.getParameter("IncludeCodingDetail")!=null && request.getParameter("IncludeCodingDetail").equals("CodingDetail");
...
boolean bCustomMapping = sDisease.indexOf(" (C)")>-1;
if(!bMech){
	sMechList="All";
}
...
params.put("Disease Area",(bCustomMapping?sDisease.substring(0, sDisease.length()-3):sDisease));
...
if(bIncludeCoding) colProperties.add(new JmesaColumnProperties("CODE_NAME", "Code Name", null, null));
